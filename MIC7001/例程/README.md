...
4. canbus.new.api.*.project   另一种接口的CAN总线例程，需要安装：CANBusAPI.package

5. RS485.*.project  	RS485通信例程

6. files.*.project   	文件操作例程

7. do_fault_detect.*.project 	输出端口故障诊断例程

8. TCP.EtherNet.CFC.*.project   基于CFC语言的以太网TCP例程
...
?    上述例程仅为展示MIC7001控制器的功能而开发的，主要用于学习用途。
